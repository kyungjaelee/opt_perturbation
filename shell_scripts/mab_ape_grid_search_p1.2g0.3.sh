...
for i in {1..9}
do
    python3 -m multi_armed_bandit.run_grid_search --noise pareto --moment 1.2 --scale 1.0 --mean one_hot --gap 0.3 --samples 5000 --arms 10 --algo ape-bounded --seed $i &
done
python3 -m multi_armed_bandit.run_grid_search --noise pareto --moment 1.2 --scale 1.0 --mean one_hot --gap 0.3 --samples 5000 --arms 10 --algo ape-bounded --seed 10
